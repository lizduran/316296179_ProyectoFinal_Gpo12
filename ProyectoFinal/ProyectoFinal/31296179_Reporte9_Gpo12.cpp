...
// Positions of the spotlight
glm::vec3 spotLightPosition(5.0f,0.0f, 5.0f);

// Direccion of the spotlight
glm::vec3 spotLightDireccion(5.0f, 0.0f, 5.0f);
...
int main()
{
	...
	Model Alacena((char*)"Models/AlacenaLizeth/alacena.obj");
	Model Estufa((char*)"Models/Estufa/estufaLiz.obj");
	Model Refrigerador((char*)"Models/Refrigerador/refri_ldg.obj");
	Model Reloj((char*)"Models/Reloj/wall_clock_liz.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Point light 1
	    glm::vec3 lightColor1; //tintineo de la esfera
		...
		// Point light 2
		glm::vec3 lightColor2; //tintineo de la esfera
		...
		// Point light 3
		glm::vec3 lightColor3; //tintineo de la esfera
		...
		// Point light 4
		glm::vec3 lightColor4; //tintineo de la esfera
